          ...
          children: [
            ...
            Container(
              ...
              child: PageView.builder(
                itemCount: mainEvent.coverImg.length,
                itemBuilder: (context, index) {
                  return Image.network(
                    "${imageBaseUrl}ev_cover_img/${mainEvent.coverImg[index]}",
                    fit: BoxFit.cover,
                  );
                },
              ),
                            ...
                            GestureDetector(
                              ...
                              child: SizedBox(
                                ...
                                child: PageView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return Image.network(
                                      "${imageBaseUrl}ev_sub_img/${subEvent.images[index]}",
                                      fit: BoxFit.cover,
                                    );
                                  },
                                ),
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Date: ${(subEvent.startDate.toString())}',
                                              style: const TextStyle(
                                                  fontSize: 14,
                                                  color: Colors.black54),
                                            ),
